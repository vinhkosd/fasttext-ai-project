...
if __name__ == "__main__":
    print("🤖 TimeAI Assistant - Nhập 'quit' để thoát\n")
    ...
    while True:
        ...
        print("\n🤖 Bot:")
        print(f"- Intent: {res['intent']} (Độ tin cậy: {res['confidence']:.1%})")
        ...
        #         print(f"Intent: {intent} (Độ tin cậy: {confidence:.1%})")
        #         print(f"Dữ liệu mẫu mà data mình sẽ hiển thị là:")
        #         print(f"\"\t{action}\"")
        #     else:
        #         print(f"Intent: {intent} (Độ tin cậy: {confidence:.1%})")
        #         print(f"Dữ liệu mẫu mà data mình sẽ hiển thị là:")
